	...
	<div class="wrapper" ref="wrapper">
		<div id="start" class="section-1">
			<div class="info" ref="section1_obItem">
				...
				<hatoButton @click="toBiliBiliLive" v-animate="
					'animate__animated animate__fadeInUp'
				">
					去黑听
				</hatoButton>
				<hatoButton v-animate="
					'animate__animated animate__fadeInUp'
				" style="margin-left: 20px" only-border @click="toBiliBiliSpace">
					成为鸠鸠人
				</hatoButton>
			</div>
			<div class="banner">
				<img style="display: block;" v-animate="
...
import HatoIntroduce from '@/view/index/components/introduce.vue';
import HatoTimeline from '@/view/index/components/timeline.vue';
